...
# menambahkan filter pada dashboard, menggunakan widget date input sebagai filternya dan akan ditempatkan pada bagian sidebar.
...
# menampilkan informasi terkait demografi pelanggan yang kita miliki
...
# menampilkan informasi parameter RFM (Recency, Frequency, & Monetary). 
